...
function Kaurosel() {
    return (
        <div><div className="max-w-2xl m-auto">
            <div id="default-carousel" className="relative mb-4 mt-4 ml-4" data-carousel="static">
                ...
                <div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                    ...
                    <div className="hidden duration-700 ease-in-out" data-carousel-item>
                        ...
                        <img src="/a1.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..." />
                    </div>

                    <div className="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="/a2.jpeg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..." />
                    </div>

                    <div className="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="/a3.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..." />
                    </div>
                </div>
            ...
            <p className="ml-4">This carousel component is part of the <a className="text-blue-600 hover:underline" href="https://flowbite.com/docs/components/carousel/" target="_blank">Flowbite component library.</a></p>
        </div><img src="/a3.jpg"  alt="..." />
        <p className="text-3xl">askhdhwadafd</p>
